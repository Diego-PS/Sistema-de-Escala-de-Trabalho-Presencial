...
bossRoutes.route('/boss/changerules/:id').post(bossValidators.changeOrganizationRules, authValidators.auth, authValidators.boss, bossController.changeOrganizationRules)
