...
memberRoutes.route('/member/changeschedule/:id').patch(memberValidators.changeDesiredSchedule, authValidators.auth, authValidators.member, memberController.changeDesiredSchedule)
