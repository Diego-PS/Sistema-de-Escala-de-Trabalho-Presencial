...
teamLeaderRoutes.route('/teamleader/changeschedule/:id').post(teamLeaderValidators.changeTeamSchedule, authValidators.auth, authValidators.teamLeader, teamLeaderController.changeTeamSchedule)
teamLeaderRoutes.route('/teamleader/changerules/:id').post(teamLeaderValidators.changeTeamRules, authValidators.auth, authValidators.teamLeader, teamLeaderController.changeTeamRules)
